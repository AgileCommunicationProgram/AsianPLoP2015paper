...
# Abstract
プロジェクトや仕事場では、コミュニケーション能力が必要とされている。
しかしながら、プロジェクトや環境におけるコミュニケーション手法についての考察は十分に適用されているとは言えず、様々な問題を引き起こしている。
本研究では、プロジェクトや仕事場におけるコミュニケーションの問題を明確にし、その解決策をパターン形式を用いて提案する。
...
## 状況
アジャイル開発など、フィードバックやシステムを構築しながら、プロジェクトや仕事を進める方法が一般的になってきた。
...
HRTのある関係性を築くためには、まず自らがHRTの構えを維持できるよう心掛けるとともに、もし双方向にHRTを持った関係性を築けないときは、ハラスメントの可能性[^yasutomi2007]があるため、距離を置くなどコミュニケーションを回避する方法が最善である。

[^yasutomi2007]: 安冨 歩, 本條 晴一郎 ハラスメントは連鎖する 「しつけ」「教育」という呪縛 (光文社新書) , 2007
...
## 状況
人は、社会的な動物である。
プロジェクトや仕事場では、複数の人が実施することが一般的である。
それぞれの人が関わっている。

## 問題
複数の人が関わると、コミュニケーション能力が必要になる。

社会の仕組みが回りだすと、あたかも自分でコントールすることができないように感じる。


## フォース
- コミュニケーション能力が大切と言われながら、根性論になってしまう。
- 問題に対して報告や相談をしたが、具体的な方法は示されない。
- 自ら創意工夫しようとすると、命令に従うように反論する。
- その場でのコミュニケーションを円滑にするスキルを身につけても、本質的な関係性は改善しない。

このようにコミュニケーションを改善することは困難である。

## 解決策
それゆえ、環境と自己の両方を改善しよう。

コミュニケーションのモデルを示す。
コミュニケーションには、環境要因と自己要因の二つがある。

![CommunicationModel1](./images/CommunicationModel1.png)

環境要因は、物理環境・論理構造（組織構造やプロセス）などの構造の上に、慣習や規範がある。

自己の典型的なモデルとしては、自我状態がある。自我状態は、健康的で効果的な状態と、非効果的な状態がある。

これらの環境要因と自我状態の両方を改善することが肝要だ。

![CommunicationModel2](./images/CommunicationModel2.png)

環境要因は、質・量を増やし、なめらかに効率的にする。
...
## 問題
心理的な問題は、リスク事項である。
心理的な状態から発生した問題を技術で解決しようとするので、作業が増えるなど、本来の解決に至らず、リスクとコストが増大するだけである。
そのため、心理的な問題を解消する必要がある。
この場合は、平常心で目が開いていれば、発生しない問題である。

しかしながら、心理的な問題について話題にすると、上から目線に取られがちなど、センシティブでナイーブな関心事である。
...
そのため、心理的な問題が発生する前に、事前にチェックリストに従い、自分の心理状態を確認し、健全な健康状態に持っていかなくてはならない。
